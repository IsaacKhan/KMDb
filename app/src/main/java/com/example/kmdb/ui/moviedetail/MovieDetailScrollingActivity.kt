...
import com.example.kmdb.databinding.ActivityMovieDetailScrollingBinding
import com.example.kmdb.ui.home.HomeActivity
            ...
            when (state) {
                ...
                is State.Success -> {
                    ...
                    state.data.let {
                        ...
                        dataBind.textImdbRating.text = "IMDb Rating: ${it.imdbrating}"
                    }
                }
                is State.Error -> {
                    dataBind.progressBar.hide()
