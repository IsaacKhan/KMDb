...
import com.example.kmdb.databinding.ActivityHomeBinding
import com.example.kmdb.ui.adapters.CustomAdapterMovies
import com.example.kmdb.ui.moviedetail.MovieDetailScrollingActivity
import com.example.kmdb.util.*
import com.example.kmdb.util.AppConstant.SHRINK_AMT
import com.example.kmdb.util.AppConstant.SHRINK_DIST
...
class HomeActivity : AppCompatActivity(), KodeinAware {
    ...
    private fun setupUI() {
        ...
        dataBind.recyclerViewMovies.apply {
            ...
            this.addItemDecoration(CustomItemDecoration(0, -1))
            ...
            addOnScrollListener(object : RecyclerView.OnScrollListener() {
                override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                    ...
                    val layoutManager = recyclerView.layoutManager as LoopingLayoutManager
                    ...
                    val d0 = 0f
                    val d1: Float = SHRINK_DIST * midpoint
                    val s0 = 1f
                    val s1: Float = 1f - SHRINK_AMT
        ...
        viewModel.moviesLiveData.observe(this, Observer { state ->
            when (state) {
                ...
                is State.Success -> {
                    ...
                    customAdapterMovies.setData(state.data).let {
                        dataBind.recyclerViewMovies.scrollToPosition(0)
                    }
                }
                is State.Error -> {
                    dataBind.progressBar.hide()
